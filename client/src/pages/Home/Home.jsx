...
function Home() {
  ...
  return (
    <div className="flex flex-col justify-center mt-6 md:mt-10 gap-10 md:gap-20 px-4 md:px-0">
      ...
      <div className="w-full sm:w-3/4 md:w-2/3 lg:w-1/2 mx-auto h-auto md:h-[50vh] flex flex-col sm:flex-row justify-center" onClick={() => navigate("/household/create-new")}>
